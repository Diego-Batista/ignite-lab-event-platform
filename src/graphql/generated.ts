...
export type GetLessonByQueryQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessonByQueryQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const GetLessonByQueryDocument = gql`
...
/**
 * __useGetLessonByQueryQuery__
 *
 * To run a query within a React component, call `useGetLessonByQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonByQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonByQueryQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessonByQueryQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonByQueryQuery, GetLessonByQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonByQueryQuery, GetLessonByQueryQueryVariables>(GetLessonByQueryDocument, options);
      }
export function useGetLessonByQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonByQueryQuery, GetLessonByQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonByQueryQuery, GetLessonByQueryQueryVariables>(GetLessonByQueryDocument, options);
        }
export type GetLessonByQueryQueryHookResult = ReturnType<typeof useGetLessonByQueryQuery>;
export type GetLessonByQueryLazyQueryHookResult = ReturnType<typeof useGetLessonByQueryLazyQuery>;
export type GetLessonByQueryQueryResult = Apollo.QueryResult<GetLessonByQueryQuery, GetLessonByQueryQueryVariables>;
